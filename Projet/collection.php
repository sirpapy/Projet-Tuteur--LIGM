				...
				for($k = 1; $k <= count ( $data->sheets [$i] [cells] [$j] ); $k ++) // This loop is created to get data in a table format.
{
				...
				if (! $name)
					continue;
				$query = "insert into collection_files(`name`, `1975`, `1976a`, `1976b`, `1992`, `1990`, `sanscompletive`, `intransitif`, `transitif`, `locatif`) values('V_" . $name . ".lgt.xls','" . $_1975 . "','" . $_1976a . "','" . $_1976b . "','" . $_1992 . "','" . $_1990 . "','" . $sanscompletive . "','" . $intransitif . "','" . $transitif . "','" . $locatif . "');";
...
<body>
<form method="POST" action="collection.php" enctype="multipart/form-data">
